public class Pickup extends PassengerCar{
    public Pickup(String carModel, String engineType, Double enginePower, Double carWeight, Integer carMileage, Double fuelConsumptionPer100km, Double accelerationTimeTo100kmPerHour){
        super(carModel, engineType, enginePower, carWeight, carMileage, fuelConsumptionPer100km, accelerationTimeTo100kmPerHour);
    }
    @Override
    public void startEngine () {
        System.out.println("Пикап "+this.getCarModel() + " с двигателем " + this.getEngineType() + " запущен и готов к перевозке пассажиров");
    }
    @Override
    public void print () {
        System.out.println("\nInformation about Pickup class object");
